...
import { Bot, Brain, Users, ArrowRight, Lightbulb, Building2, GraduationCap, Heart, Calendar } from 'lucide-react';
...
function App() {
  ...
  return (
    <Routes>
      <Route path="/services" element={<ScheduleServices />} />
      <Route path="/" element={
          ...
          <div className="bg-[#D3F2F7] py-24">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-600 mb-8">Ready to explore how we can help? Book a consultation with us.</p>
                <div className="w-32 h-1 bg-[#23C0D8] mx-auto mb-12"></div>
                <Link 
                  to="/services"
